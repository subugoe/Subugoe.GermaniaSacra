...
class UrltypRepository extends Repository {
	...
	*/
	protected  $entities = array('name' => 'urltyp');

	/*
	 * Searches and returns a limited number of Urltyp entities as per search terms or the total number of search result
	...
	public function searchCertainNumberOfLand($offset, $limit, $orderings, $searchArr, $mode) {
		...
		->resetDQLParts()
		->select('urltyp')
		->from('\Subugoe\GermaniaSacra\Domain\Model\Urltyp', 'urltyp');
		$operator = 'LIKE';
