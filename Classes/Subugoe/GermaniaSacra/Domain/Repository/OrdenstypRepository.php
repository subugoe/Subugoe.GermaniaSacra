...
class OrdenstypRepository extends Repository {
	...
	*/
	protected  $entities = array('ordenstyp' => 'ordenstyp');

	/*
	 * Searches and returns a limited number of Ordenstyp entities as per search terms or the total number of search result
	 ...
	 */
	public function searchCertainNumberOfOrdenstyp($offset, $limit, $orderings, $searchArr, $mode) {
		...
		->resetDQLParts()
		->select('ordenstyp')
		->from('\Subugoe\GermaniaSacra\Domain\Model\Ordenstyp', 'ordenstyp');
		$operator = 'LIKE';
