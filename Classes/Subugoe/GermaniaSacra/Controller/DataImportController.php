...
class DataImportController extends AbstractBaseController
{
    ...
    {
        $personallistenstatusArr = [1 => 'Erfassung aus den Registern der Germania-Sacra-Bände (in Bearbeitung):',
        ...
        foreach ($csv as $key => $value) {
            if ($key > 0) {
                ...
                if (isset($titel) && !empty($titel)) {
                    $csvArr[$titel] = ['title' => $titel, 'citekey' => $citekey, 'detail' => $detail];
                }
            }
        }
