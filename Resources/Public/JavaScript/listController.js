...
var dataTable, deleteAction, initList, readListAction, updateListAction;
...
readListAction = function(type) {
  ...
  $table.on("click", ".edit", function(e) {
    e.preventDefault();
    return readAction(type, $(this).closest('tr').find(':input[name=uUID]').val());
  });
...
updateListAction = function(type) {
  ...
  return $.post(type + '/updateList', formData).done(function(respond, status, jqXHR) {
