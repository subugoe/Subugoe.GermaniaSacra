...
germaniaSacra.config(function($routeProvider, $locationProvider) {
  var templatePath;
  ...
  return $routeProvider.when('/', {
    ...
    templateUrl: templatePath + 'Kloster.html'
  }).when('/ort', {
    templateUrl: templatePath + 'Ort.html'
  }).when('/orden', {
    templateUrl: templatePath + 'Orden.html'
  }).when('/band', {
    templateUrl: templatePath + 'Band.html'
  }).when('/bistum', {
    templateUrl: templatePath + 'Bistum.html'
  }).when('/land', {
    templateUrl: templatePath + 'Land.html'
  }).when('/literatur', {
    templateUrl: templatePath + 'Literatur.html'
  }).when('/bearbeitungsstatus', {
    templateUrl: templatePath + 'Bearbeitungsstatus.html'
  }).when('/personallistenstatus', {
    templateUrl: templatePath + 'Personallistenstatus.html'
  }).when('/ordenstyp', {
    ...
    templateUrl: templatePath + 'Importdump.html'
  }).otherwise({
    redirectTo: '/'
  });
});
